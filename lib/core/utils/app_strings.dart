...
class AppStrings {
  ...
  static String confirmDeleteBookmarkMessage(String type) =>
      'هل أنت متأكد من حذف هذه العلامة المرجعية من $type؟';
  ...
  static const List<JuzsListEntity> juzsList = [
    ...
    JuzsListEntity('ٱلْجُزْءُ ٱلْأَوَّلُ', 1, 1, 1, 21, 148),
    JuzsListEntity('ٱلْجُزْءُ ٱلثَّانِي', 2, 22, 149, 41, 259),
    JuzsListEntity('ٱلْجُزْءُ ٱلثَّالِثُ', 3, 42, 260, 62, 385),
    JuzsListEntity('ٱلْجُزْءُ ٱلرَّابِعُ', 4, 62, 386, 81, 516),
    JuzsListEntity('ٱلْجُزْءُ ٱلْخَامِسُ', 5, 82, 517, 101, 640),
    JuzsListEntity('ٱلْجُزْءُ ٱلسَّادِسُ', 6, 102, 641, 121, 750),
    JuzsListEntity('ٱلْجُزْءُ ٱلسَّابِعُ', 7, 121, 751, 141, 899),
    JuzsListEntity('ٱلْجُزْءُ ٱلثَّامِنُ', 8, 142, 900, 161, 1041),
    JuzsListEntity('ٱلْجُزْءُ ٱلتَّاسِعُ', 9, 162, 1042, 181, 1200),
    JuzsListEntity('ٱلْجُزْءُ ٱلْعَاشِرُ', 10, 182, 1201, 201, 1327),
    JuzsListEntity('ٱلْجُزْءُ ٱلْحَادِي عَشَرَ', 11, 201, 1328, 221, 1478),
    JuzsListEntity('ٱلْجُزْءُ ٱلثَّانِي عَشَرَ', 12, 222, 1479, 241, 1648),
    JuzsListEntity('ٱلْجُزْءُ ٱلثَّالِثُ عَشَرَ', 13, 242, 1649, 261, 1802),
    JuzsListEntity('ٱلْجُزْءُ ٱلرَّابِعُ عَشَرَ', 14, 262, 1803, 281, 2029),
    JuzsListEntity('ٱلْجُزْءُ ٱلْخَامِسُ عَشَرَ', 15, 282, 2030, 301, 2214),
    JuzsListEntity('ٱلْجُزْءُ ٱلسَّادِسُ عَشَرَ', 16, 302, 2215, 321, 2483),
    JuzsListEntity('ٱلْجُزْءُ ٱلسَّابِعُ عَشَرَ', 17, 322, 2484, 341, 2673),
    JuzsListEntity('ٱلْجُزْءُ ٱلثَّامِنُ عَشَرَ', 18, 342, 2674, 361, 2875),
    JuzsListEntity('ٱلْجُزْءُ ٱلتَّاسِعُ عَشَرَ', 19, 362, 2876, 381, 3214),
    JuzsListEntity('ٱلْجُزْءُ ٱلْعِشْرُونَ', 20, 382, 3215, 401, 3385),
    JuzsListEntity(
    ...
    JuzsListEntity('ٱلْجُزْءُ ٱلثَّلَاثُونَ', 30, 582, 5673, 604, 6236),
  ];
}
