class EndPoint {
  // ── Server base URL ───────────────────────────────────────────────────────
  /// Resolved at compile-time from the `SHAFEEATEACH_API_URL` env variable.
  /// Pass with: `--dart-define=SHAFEEATEACH_API_URL=https://api.shafeeaTeach.app`
  /// Falls back to the Android emulator loopback address in development.
  static const String baseUrl = String.fromEnvironment('SHAFEEATEACH_API_URL');
