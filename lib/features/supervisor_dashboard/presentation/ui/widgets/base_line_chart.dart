    ...
    return Row(
      ...
      children: [
        if (widget.plannedLineColor != null &&
          ...
          _buildLegendItem(L10nStrings.AppStrings.planned, widget.plannedLineColor!),
        SizedBox(width: 24),
        _buildLegendItem(L10nStrings.AppStrings.actualImplementation, widget.actualLineColor),
      ],
    );
  }
