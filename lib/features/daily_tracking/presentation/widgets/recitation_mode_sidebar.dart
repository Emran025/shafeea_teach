        ...
        return RecitationModeSideBar(
          ...
          items: [
            ...
            CustomModeIconButton(
              ...
              label: L10nStrings.AppStrings.startCall,
              isSelected: false,
              onTap: () {
                Navigator.of(context).pop();
                // TODO: Trigger WebRTC Call Accept/Join here
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text(L10nStrings.AppStrings.startingInteractiveSession)),
                );
              },
            ),
            CustomModeIconButton(
            ...
            CustomModeIconButton(
              ...
              label: L10nStrings.AppStrings.back,
              isSelected: false,
              onTap: () {
                Navigator.of(context).pop();
                Navigator.of(context).pop();
